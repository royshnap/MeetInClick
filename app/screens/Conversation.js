...
const Conversation = ({ route, navigation }) => {
    ...
    const { activeConversation, conversationLoading, conversationLoadingError, sendMessageToConversation } = useActiveConversation({ route, navigation });
    ...
    if (conversationLoadingError || !activeConversation) {
        return <View>
            <Text>Opps! there was an error loading conversation. <Link to={{ screen: "Conversations" }}>Back to conversation list</Link></Text>
        </View>
    }
