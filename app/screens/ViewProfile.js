...
//   const [showNotification, setShowNotification] = useState(false); // State to control notification visibility  const route = useRoute();
//   const route = useRoute();
//   const navigation = useNavigation();
//   const {
//     backgroundImage,
...
//         const hasNewMatch = !!notifications.newMatches;
//         const hasNewMessage = !!notifications.newMessages;
//         setHasNewNotification(hasNewMatch || hasNewMessage);
  
//         if (hasNewMatch) {
//           setNotificationContent("You have a new match!");
//         } 
//         if (hasNewMessage) {
//           setNotificationContent("You have a new message!");
//         }
//       } else {
//         setHasNewNotification(false);
//       }
...
//           </View>
//         )}
//         {/* Notification Container - Added */}
//         {showNotification && (
//           <View style={styles.notificationContainer}>
//             <Text style={styles.notificationText}>{notificationContent}</Text>
//             <TouchableOpacity onPress={handleNotificationPress}>
//               <Text style={styles.closeButton}>Close</Text>
//             </TouchableOpacity>
//           </View>
